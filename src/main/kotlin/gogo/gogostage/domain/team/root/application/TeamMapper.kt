...
class TeamMapper {
    ...
    fun mapParticipantInfoDto(team: Team, students: List<StudentByIdsStubDto>): List<ParticipantInfoDto> =
    ...
    fun mapTeamInfoDto(team: Team, participantDto: List<ParticipantInfoDto>): TeamInfoDto =
        TeamInfoDto(
            teamId = team.id,
            teamName = team.name,
